...
Please make sure to preprocess and run your diffusion MRI data through the ENIGMA TBSS pipeline first and only use data for the subsequent preImputationQC from individuals who passed this pipeline.
